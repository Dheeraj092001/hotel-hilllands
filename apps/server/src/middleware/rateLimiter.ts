...
export const bookingLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  message: { success: false, message: "Too many booking attempts", code: "RATE_LIMIT_EXCEEDED" },
});
...
export const paymentLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  message: { success: false, message: "Too many payment attempts", code: "RATE_LIMIT_EXCEEDED" },
});
